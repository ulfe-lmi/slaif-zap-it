...
| BLIP3 verification | Pinned FP16 holder; low-card service path swaps SAM2+CLIP and BLIP3, while >=24-GB path keeps all three resident | Public L2/L3 fields when executed; >=24-GB qualification deferred to 007-c |
